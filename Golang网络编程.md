...
![Snipaste_2021-04-02_00-54-29](./asset_6/Snipaste_2021-04-02_00-54-29.png)

客户端

![Snipaste_2021-04-05_00-59-14](./asset_6/Snipaste_2021-04-05_00-59-14.png)

### 2.6 redis添加用户

![Snipaste_2021-04-05_17-40-37](./asset_6/Snipaste_2021-04-05_17-40-37.png)

如输入的用户名密码在 Redis中存在则登录，否则退出系统，并给出相应的提示信息:
		1.用户不存在你也可以重新注册，再登录
		2.你密码不正确
...
![Snipaste_2021-04-06_01-24-38](./asset_6/Snipaste_2021-04-06_01-24-38.png)

（1）登录成功后显示在线用户

（2）当一个新的用户上线后，其他已经登录的用户也能获取最新在线用户列表

###  2.9 实现群聊功能

（1）客户端：用户上线后，可以将群聊消息发送给服务器

（2）服务器：接收客户端的消息，群发给所有在线的用户（除发送者外）
